...
public final class Ea extends C0116j6 {
    public G8 g;

    public Ea(C0116j6 c0116j6, int i) {
        super(c0116j6, i);
    }
    ...
    public final <T> T d(InterfaceC0056e6<? extends T> interfaceC0056e6) {
        return interfaceC0056e6 instanceof ib ? (T) ((ib) interfaceC0056e6).B(this) : interfaceC0056e6.f(this);
    }
