...
import com.github.catvod.spider.XPathHdmoli;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                XPathHdmoli moli = new XPathHdmoli();
                moli.init(MainActivity.this, "http://192.168.1.6:81/tv/username/tvcat/pwd/EM952-ExdGN-9ojqt-2yGHD-4KGxC/hdmoli");
                String json = moli.playerContent(null,"play/1289-0-0.html", null);
